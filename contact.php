            ...
            <div class="container px-5">
                <div class="bg-light rounded-4 py-5 px-4 px-md-5">
                    <div class="text-center mb-5">
                        ...
                        <h1 class="fw-bolder">Contactate con nosotros.</h1>
                        <p class="lead fw-normal text-muted mb-0">¡Trabajemos juntos!</p>
                    </div>
                    <div class="row gx-5 justify-content-center">
                        <div class="col-lg-8 col-xl-6">
                            <!-- Formulario SB Forms Contact -->
                            <form id="contactForm" action="process_contact.php" method="post" data-sb-form-api-token="API_TOKEN">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <label for="email">Direccion de Correro</label>
                                ...
                                <!-- Mensaje de éxito del envío del formulario (se muestra cuando el envío es exitoso) -->
                                ...
                                <!-- Mensaje de error del envío del formulario (se muestra cuando hay un error) -->
        ...
        <footer class="bg-white py-4 mt-auto">
            <div class="container px-5">
                <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                    <div class="col-auto"><div class="small m-0">Copyright &copy; Nuestro Sitio 2023</div></div>
                    <div class="col-auto">
